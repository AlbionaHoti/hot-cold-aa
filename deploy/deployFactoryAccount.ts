...
const default async function(hre: HardhatRuntimeEnvironment) {
    ...
    /* 
        Two main function calls for deployment are
        - deployAccount
        - create2Address
    ...
    */
    ...
    const tx = await aaFactory.deployAccount(salt, owne.address);
    await tx.wait();
